...
function StudyprogramInfo({ studydirection, imagelocation, imagealt, pheadstyle, studyprogram, studyprogramtext, studyprogramtext2, studybuttonstyle, page, instapage, iconalt, facebookpage, iconalt2 }) {
    return (
...
export default function HomeContent() {
    return (
        <div>
            <StudyprogramInfo
                studydirection={"flex flex-col justify-center items-center md:flex-row md:justify-between"}
            ...
            <StudyprogramInfo
                studydirection={"flex flex-col justify-center items-center md:flex-row-reverse md:justify-between"}
